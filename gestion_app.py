...
if st.session_state.get("nt_visible", True):
    ...
    # ===== CSS: card SOLO del bloque de Nueva tarea (sin borde global) =====
    st.markdown("""
    <style>
      /* Aplica SOLO dentro del scope de Nueva tarea */
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel){
        background:#ffffff;
      ...
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stTextInput,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stSelectbox,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stDateInput,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stTimeInput,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stTextArea{
        width:100% !important;
      }
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stTextInput > div,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stSelectbox > div,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stDateInput > div,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stTimeInput > div,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) .stTextArea > div{
        width:100% !important; max-width:none !important;
      }
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) [data-testid="stDateInput"] input,
      #nt-scope div[data-testid="stVerticalBlock"]:has(> #nt-card-sentinel) [data-testid^="stTimeInput"] input{
        width:100% !important;
      }
    </style>
    """, unsafe_allow_html=True)

    # ===== Scope + contenedor ENMARCADO =====
    st.markdown('<div id="nt-scope">', unsafe_allow_html=True)
    submitted = False
    with st.container():
        # Sentinel: el card se aplica a ESTE contenedor (no a toda la página)
    ...
    st.markdown('</div>', unsafe_allow_html=True)  # cierra #nt-scope
