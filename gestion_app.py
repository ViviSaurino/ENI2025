...
<style>
  ...
  .eni-main-topbar{
    ...
    margin:0 -80px 29px -80px;   /* top  right  bottom  left */
  ...
  *::-webkit-scrollbar{
  ...
  div[data-testid="stHorizontalBlock"]{
    gap: 0.35rem !important;        /* antes ~1rem, ahora casi nada */
...
if section == "Gestión de tareas":
    ...
    col_left, col_gap, col_right = st.columns([3, 0.1, 1.6])
