...
def check_app_password() -> bool:
    ...
    <style>
      .eni-hero-title{
        font-size:102px;          /* BIEN / VENIDOS grande */
        font-weight:900;
        color:#B38CFB;
        line-height:0.80;
        margin-bottom:10px;
    ...
    with col1:
        ...
        form_col, _ = st.columns([0.90, 0.52])  # <-- controla el ancho de la píldora e inputs
        with form_col:
    ...
    with col2:
        ...
        if hero_video.exists():
            ...
            video_html = f"""
            <div style="margin-left:-140px; margin-top:-240px;">
